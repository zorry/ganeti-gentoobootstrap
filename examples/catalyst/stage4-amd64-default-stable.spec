...
stage4/packages: syslog-ng dhcpcd logrotate bc
...
boot/kernel/gentoo/config: /etc/ganeti/instance-gentoobootstrap/catalyst/linux-3.16.5-gentoo.config
...
boot/kernel/gentoo/packages: lvm2 nfs-utils grub:2
...
stage4/empty: /usr/portage/ /tmp /var/log /etc/portage
